                ...
                <TD style="PADDING-TOP: 8px" vAlign=top height=185><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD style="PADDING-TOP: 8px" align=middle class=newsline><p align="center">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FA8A89" style="border-collapse:collapse">
                          <tr>
                            <td height="46" align="center" class="STYLE7">${bean.xtitle }  </td>
                          </tr>
                          <tr>
                            <td height="110" align="left">${bean.xcontent }</td>
                          </tr>
                          <tr>
