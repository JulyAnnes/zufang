	...
	return true;
                      ...
                      <form name="form1" method="post" action="${url }" onsubmit="return checkfrom()" enctype="multipart/form-data">
                        ...
                        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          <tr>
                            <td>房源类型：</td>
                            <td><input name='leixing' type='text' id='leixingid' style="width: 300px;" value="${bean.leixing }"  />
                              </td>
                          </tr>
                          <tr>
                            <td>房源区域：</td>
                            <td><input name='quyu' type='text' id='quyuid' style="width: 300px;" value="${bean.quyu }"  />
                              </td>
                          </tr>
                          <tr>
                            <td>房源名称：</td>
                            <td><input name='mingchen' type='text' id='mingchenid' style="width: 300px;"  value="${bean.mingchen }" />
                              </td>
                          </tr>
                          
                          <tr>
                            <td>房源图片01：</td>
                            <td><img src="uploadfile/${bean.path }" width="200" height="200" border="0" />
                              </td>
                          </tr>
                          ...
                          <tr>
                            <td>房源图片02：</td>
                            <td><img src="uploadfile/${bean.path2 }" width="200" height="200" border="0" />
                              </td>
                          </tr>
                          ...
                          <tr>
                            <td>房源图片03：</td>
                            <td><img src="uploadfile/${bean.path3 }" width="200" height="200" border="0" />
                              </td>
                          </tr>
                          ...
                          <tr>
                            <td>装修程度：</td>
                            <td><input name='zhuangxiu' type='text' id='zhuangxiuid' style="width: 300px;"  value="${bean.zhuangxiu }" />
                              </td>
                          </tr>
                          <tr>
                            <td>月租金：</td>
                            <td><input name='money' type='text' id='moneyid' style="width: 300px;"  value="${bean.money }" />
                              </td>
                          </tr>
                          
                          <tr>
                            <td>面积：</td>
                            <td><input name='mianji' type='text' id='mianjiid' style="width: 300px;"  value="${bean.mianji }" />
                              </td>
                          </tr>
                          ...
                          <tr>
                            <td>租赁说明：</td>
                            <td>
                            <textarea rows="7" cols="50"  name="shouming">${bean.shouming }</textarea>
                            </td>
                          </tr>
