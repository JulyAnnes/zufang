...
border=0>
  ...
  <TR>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
   	 ...
   	 <tr>
     <td width='11%'>租赁者姓名：</td>
     <td width='39%'>${bean.xingming }</td>
      <td width='11%'>手机号码：</td>
     <td width='39%'>${bean.tel }</td>
    
     </tr>
   	 
   	 <tr>
     <td width='11%'>编号：</td>
     <td width='39%'>${bean.house.bianhao }</td>
      <td width='11%'>房源图片：</td>
     <td width='39%'><img src="uploadfile/${bean.house.path }" width="100" height="100" border="0" /></td>
    
     </tr>
     
     
      <tr>
     <td width='11%'>房源类型：</td><td width='39%'>${bean.house.leixing }</td>
     <td width='11%'>面积：</td><td width='39%'>${bean.house.mianji }</td>
     </tr>
     
     <tr>
     <td width='11%'>房源区域：</td><td width='39%'>${bean.house.quyu }</td>
     <td width='11%'>房源名称：</td><td width='39%'>${bean.house.mingchen }</td>
     </tr>
     
     <tr>
     <td width='11%'>装修程度：</td><td width='39%'>${bean.house.zhuangxiu }</td>
     <td width='11%'>月租金：</td><td width='39%'>${bean.house.money }</td>
     </tr>
     
     <tr>
     <td width='11%' height="137">租房说明：</td><td colspan="3">${bean.shouming }</td>
