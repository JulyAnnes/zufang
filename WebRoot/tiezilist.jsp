          ...
          <TD vAlign=top>
            ...
            background=qtimages/zjgdj_79.gif border=0>
              ...
              <TR>
               ...
               帖子标题:<input name="ltitle"  type="text" value="${ltitle }"/> 
                 <input value="搜索" type="submit"/>
                &nbsp;&nbsp;&nbsp;
                <!-- 
                <input value="发帖" type="button" onclick="window.location.href='indexmethod!tieziadd';" />
                 -->
                </form>
                ...
                <TD style="PADDING-TOP: 8px" vAlign=top height=185><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD style="PADDING-TOP: 8px" align=middle class=newsline><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#FA9090" style="border-collapse:collapse">
                        ...
                        <c:forEach items="${tiezilist}" var="bean">
                        
                        <tr>
                         
                         <td width="10%">${bean.house.mingchen }</td>
                          <td width="10%">${bean.ltitle }</td>
                          <td width="10%">${bean.ctime }</td>
                          <td width="20%">${bean.user.xingming }</td>
                          
                          <td width="10%" align="center">
                          
                          <a href="indexmethod!tieziupdate3?id=${bean.id }" >查看详情</a>
                          
                          <a href="indexmethod!tiezidelete?id=${bean.id }" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
