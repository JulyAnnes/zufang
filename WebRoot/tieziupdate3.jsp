...
function checkfrom()
{
	...
	return true;
                      ...
                      <form name="form1" method="post" action="indexmethod!huifuadd2?tieziid=${bean.id }" onsubmit="return checkfrom()">
                      
                        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          <tr>
                            <td>房源名称：</td>
                            <td><input name='ltitle' type='text' id='ltitleid' style="width: 300px;"  value="${bean.house.mingchen }" readonly="readonly" />
                              &nbsp;*</td>
                          </tr>
                          <tr>
                            <td>帖子标题：</td>
                          ...
                          <tr>
                           ...
                           <tr>
                            <td>回复内容：</td>
                            <td>
                            <textarea rows="7" cols="50"  name="hcontent"></textarea>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td>
                            <input type="submit" name="Submit5" value="回复"  style=" height:30px; border:solid 1px #000000; color:#666666"/>
                          ...
                          <c:forEach items="${huifulist}" var="huifu">
                          <tr>
                          
                            <td colspan="2">
                           ${huifu.user.xingming }在${huifu.ctime }回复说:${huifu.hcontent }
